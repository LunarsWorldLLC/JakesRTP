...
public class SafeLocationUtils {
    ...
    static {
        ...
        // Legacy (<= 1.12) material patches are no longer bundled, and every supported server is well
        // past that version, so we always use the modern material logic via the blank patch.
